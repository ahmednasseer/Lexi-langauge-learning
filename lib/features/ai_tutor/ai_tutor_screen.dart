  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        id: '0',
        content:
            'Hello! 👋 I\'m your AI language tutor./n/nI can help you:/n• Practice conversations/n• Correct your grammar/n• Explain rules/n• Suggest exercises/n/nWhat would you like to practice?',
        isUser: false,
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx); /* Navigate to subscription */
            },
