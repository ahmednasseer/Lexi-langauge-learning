  ...
  static List<AchievementBadge> getAllBadges() {
    return [
      ...
      AchievementBadge(
        ...
        requirement: 1,
        rewardXp: 50,
        assetPath: AppAssets.achievementFirstWord,
      ),
      AchievementBadge(
        id: 'b2',
        name: '100 Words',
        ...
        requirement: 100,
        rewardXp: 100,
        assetPath: AppAssets.achievement100Words,
      ),
      const AchievementBadge(
        id: 'b3',
        name: '500 Words',
      ...
      AchievementBadge(
        ...
        requirement: 7,
        rewardXp: 100,
        assetPath: AppAssets.achievementStreak7,
      ),
      AchievementBadge(
        id: 'b6',
        name: '30 Day Streak',
        ...
        requirement: 30,
        rewardXp: 300,
        assetPath: AppAssets.achievementStreak30,
      ),
      const AchievementBadge(
        id: 'b7',
        name: '100 Day Streak',
      ...
      const AchievementBadge(
        ...
        description: 'Get 100% pronunciation score',
        icon: '✨',
        category: 'speaking',
        requirement: 1,
        rewardXp: 200,
