      ...
      if (mounted) {
        setState(() {
          _friends = users
              .map((u) => _FriendData(
                    name: u.name,
                    status: u.isPremium ? 'مميز' : (u.streak > 0 ? 'متصل' : 'غير متصل'),
                    isOnline: u.streak > 0,
              ...
              child: _isLoading
                  ...
                  : _error != null
                      ...
                      : _friends.isEmpty
                          ...
                          itemBuilder: (context, index) => _buildFriendCard(_friends[index], index),
                        ),
            ),
            ...
            Stack(
              children: [
                Container(
                  ...
                  height: 50,
                  decoration: BoxDecoration(
                    gradient: friend.isOnline ? AppColors.primaryGradient : null,
                    color: friend.isOnline ? null : AppColors.surfaceLight,
                    shape: BoxShape.circle,
                    border: Border.all(
                      color: friend.isOnline ? AppColors.primary : AppColors.border,
                    ),
                  ),
                  child: Center(
                    child: Text(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    height: 14,
                    decoration: BoxDecoration(
                      color: friend.isOnline ? AppColors.success : AppColors.textHint,
                      shape: BoxShape.circle,
