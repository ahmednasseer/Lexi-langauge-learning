...
class _PassportScreenState extends State<PassportScreen> {
  ...
  final List<_LanguageOption> _languages = [
    _LanguageOption(name: 'الألمانية', nativeName: 'Deutsch', flag: '🇩🇪'),
    _LanguageOption(name: 'الإنجليزية', nativeName: 'English', flag: '🇬🇧'),
    _LanguageOption(name: 'الفرنسية', nativeName: 'Français', flag: '🇫🇷'),
    _LanguageOption(name: 'اليابانية', nativeName: '日本語', flag: '🇯🇵'),
    _LanguageOption(name: 'الإسبانية', nativeName: 'Español', flag: '🇪🇸'),
  ];
