  ...
  Future<void> _listen() async {
    ...
    await _speechService.startListening(
      ...
      onDone: () async {
        ...
        final spoken = _speechService.evaluate(
          _target,
          _speechService.lastRecognizedWords,
        );
        setState(() {
          _isListening = false;
              ...
              Center(
                child:
                    GestureDetector(
                        ...
                        .animate(
                          onPlay: _isListening ? (c) => c.repeat() : null,
                        )
                        .scale(
                ...
                return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: isCur ? AppColors.primary : AppColors.border,
                            width: 2,
                          ),
                        ),
                        child: Row(
